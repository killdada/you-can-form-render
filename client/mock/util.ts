...
const resolvePath = (param: string) => path.join(__dirname, 'json', `${param}.json`);
 ...
 */
export const getMockDataByPath = (jsonPath: string, key?: any, defaultVal = {}) => {
 ...
 * @returns jsonPath文件导出对象[key] 的接口信息
 */
export const saveMockDataByPath = async (jsonPath: string, data: any, key?: any) => {
